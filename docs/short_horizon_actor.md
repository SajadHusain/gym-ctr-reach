...
The `short_horizon_active_*` fields report gradient ratios, conflict and step
acceptance averaged only over scheduled updates with valid windows. Use these
to check whether the window derivative is nonzero and survives integration.
